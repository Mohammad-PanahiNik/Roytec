...
const Footer = () => {
    return (
        ...
        //     <div className="row">
        //         <div className="social-media col-lg-5 t text-center">
        //             <h4>شبکه های اجتماعی</h4>
        //             <div className="col-lg-10 col-lg-offset-1 d-flex align-items-end justify-content-between ">
        ...
        //                 </div>
        //             </div>
        //             <div className="col-lg-10 col-lg-offset-1 d-flex">
        ...
        //             <img src={logo} alt=""/>
        //             <p className="ms-5">roytec2023@gmail.com</p>
        //             <p>+98-9018605742</p>
        //         </div>
        //     </div>
        //     <div className="row copy w-100 d-flex align-items-center py-5">
